...
<script>
  window.onload = function() {
    ...
    const ui = SwaggerUIBundle({
      ...
      onComplete: () => {
        console.log('{{ \App\Models\Doctor::first()->api_token }}')
        ui.preauthorizeApiKey("doctor_auth", '{{ \App\Models\Doctor::first()->api_token }}')
      },
      responseInterceptor:  function(response) {
        if(response.headers.authorization) {
          ui.preauthorizeApiKey("patient_auth", 'Bearer ' + response.headers.authorization)
        }
      },
      presets: [
